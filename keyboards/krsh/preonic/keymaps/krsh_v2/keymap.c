...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_preonic_grid(
        ...
        KC_ESC,     KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,    KC_N,     KC_M,        KC_COMM,  KC_DOT,   KC_UP,    RSFT_T(KC_ENT),
    ...
    [_F_KEYS] = LAYOUT_preonic_grid(
        ...
        _______,  KC_F11,   KC_F12,   _______,  _______,  KC_LPRN,  KC_RPRN,  KC_DQUO,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DEL,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_planck_grid(
        ...
        KC_LCTL,  LALT_T(OSL(4)),  KC_LGUI,  TT(_XTRA),TT(_RAISE),KC_BSPC,  KC_SPC,   TT(_LOWER),KC_SLSH,  KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
